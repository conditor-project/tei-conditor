...
Cette feuille de style traite les notices de thèses françaises issus de la bbiliographie nationale des thèses dans leur version de soutenance signalés dans le Sudoc en format Unimarc version XMLlisée.
