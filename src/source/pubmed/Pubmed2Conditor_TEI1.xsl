...
<!-- ========================================================================================================
      ...
      Ce XSL traite la forme adoptée pour les corpus à venir.
      - idno analytic dans 'analytic'
      - abstract avec fils (p)
...
<xsl:template match="Abstract"> 
    ...
    Et on ne crée pas plusieurs 'p' typés, mais un seul p pour tout le résumé (2018-09-10)     
